...
root_dir = '/home/yuki/workspace/DHP19EPC_dataset/test_MeanLabel/label/'
out_dir = '/home/yuki/workspace/DHP19EPC_dataset/test_MeanLabel_extract/label/'
...
def extract_frames_labels(label_file_dir, out_dir, P_mat_cam_all, image_info):
    ...
    for frame_num in range(data_len):
        for cam in range(4):
            ...
            u = u.astype(np.int32)
            v = v.astype(np.int32)
            label_name = "S{}_session{}_mov{}_frame{}_cam{}_label{}.npy".format(
