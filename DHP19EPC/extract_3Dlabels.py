...
out_dir = '/home/yuki/workspace/DHP19EPC_dataset/test_MeanLabel_extract/3Dlabel/'
...
def extract_frames_3Dlabels(label_file_dir, out_dir, image_info):
    ...
    for frame_num in range(data_len):
        ...
        label_name = "S{}_session{}_mov{}_frame{}_3Dlabel{}.npy".format(
            sub, session, mov, frame_num, "")
