...
root_dir = '/home/yuki/workspace/DHP19EPC_dataset/test_LastLabel/data/'
out_dir = '/home/yuki/workspace/DHP19EPC_dataset/test_LastLabel_extract/data/'
...
def extract_frames(file_dir, out_dir):
    ...
    for frame_num in range(data_len):
        ...
        frame_name = "S{}_session{}_mov{}_cam{}_frame{}{}.npy".format(
